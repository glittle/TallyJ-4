...
namespace Backend.Migrations
{
    ...
    [Migration("20260809040000_RemoveOnlineAnnounced")]
    partial class RemoveOnlineAnnounced
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Backend.Entities.Ballot", b =>
                {
            ...
            modelBuilder.Entity("Backend.Entities.Election", b =>
                {
                    b.Property<int>("RowId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<bool>("UseOnlineVoting")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("Backend.Entities.JoinElectionUser", b =>
                {
                    b.Property<int>("RowId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Backend.Entities.OnlineVoter", b =>
                {
                    b.Property<int>("RowId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Backend.Entities.OnlineVotingInfo", b =>
                {
                    b.Property<int>("RowId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Backend.Entities.ResultSummary", b =>
                {
                    b.Property<int>("RowId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Backend.Entities.ResultTie", b =>
                {
                    b.Property<int>("RowId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Backend.Entities.SecurityAuditLog", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Backend.Entities.SmsLog", b =>
                {
                    b.Property<int>("RowId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Backend.Entities.Teller", b =>
                {
                    b.Property<int>("RowId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Backend.Entities.TwoFactorToken", b =>
                {
                    b.Property<int>("RowId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Backend.Entities.Computer", b =>
                {
                    b.HasOne("Backend.Entities.Election", "Election")
                        .WithMany()
            ...
            modelBuilder.Entity("Backend.Entities.TwoFactorToken", b =>
                {
                    b.HasOne("Backend.Identity.AppUser", null)
                        ...
                        .HasForeignKey("Backend.Entities.TwoFactorToken", "UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("Backend.Entities.Vote", b =>
                {
                    b.HasOne("Backend.Entities.Ballot", "Ballot")
                        .WithMany("Votes")
