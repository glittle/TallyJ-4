    ...
    public async Task SendPasswordResetEmailAsync(string toEmail, string resetToken)
    {
        ...
        var bodyBuilder = new BodyBuilder
        {
            HtmlBody = $@"
                ...
                <p>You requested a password reset for your TallyJ4 account.</p>
...
You requested a password reset for your TallyJ4 account.
    ...
    public async Task Send2FASetupEmailAsync(string toEmail, string qrCodeBase64)
    {
        ...
        var bodyBuilder = new BodyBuilder
        {
            HtmlBody = $@"
                ...
                <p>You have enabled two-factor authentication for your TallyJ4 account.</p>
...
You have enabled two-factor authentication for your TallyJ4 account.
