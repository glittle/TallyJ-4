...
public class SecureCookieMiddlewareTests
{
    ...
    public void SetAuthCookies_SetsAllRequiredCookies()
    {
        ...
        // Act
        SecureCookieMiddleware.SetAuthCookies(httpContext, accessToken, refreshToken, email, name, authMethod, isHttps);
        ...
        Assert.Equal(SameSiteMode.Strict, accessCookie.SameSite);
        ...
        Assert.Equal(SameSiteMode.Strict, refreshCookie.SameSite);
        ...
        Assert.Equal(SameSiteMode.Strict, emailCookie.SameSite);
        ...
        Assert.Equal(SameSiteMode.Strict, nameCookie.SameSite);
        ...
        Assert.Equal(SameSiteMode.Strict, methodCookie.SameSite);
    }
