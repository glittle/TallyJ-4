    ...
    <el-card>
      <template #header>
        <div class="card-header">
          <div class="header-left">
            <el-page-header @back="goBack" content="Tellers" />
          </div>
      ...
      <div class="table-container">
        ...
        >
          ...
          <el-table-column prop="usingComputerCode" label="Computer Code" width="150" align="center">
...
const currentPage = computed({
  ...
  set: (val) => { tellerStore.currentPage = val }
})
const pageSize = computed({
  get: () => tellerStore.pageSize,
  set: (val) => { tellerStore.pageSize = val }
})
