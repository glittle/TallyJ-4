...
describe('phoneticMatch', () => {
  ...
  it('should return 65 for medium similarity (>= 50%)', () => {
    const person = createMockPerson('Alexander', 'McFarland', '', '', ['A425', 'M216']);
...
describe('applyAllStrategies', () => {
  ...
  it('should apply phonetic match when other strategies fail', () => {
    const person = createMockPerson('McFarland', 'Alexander', '', '', ['M216', 'A425']);
...
describe('Edge Cases', () => {
  ...
  it('should handle very long names', () => {
    const person = createMockPerson('Wolfeschlegelsteinhausenbergerdorff', 'Jr');
