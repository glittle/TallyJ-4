<template>
  <div class="ds-error-display" :class="[typeClass, sizeClass]">
    ...
    <div class="ds-error-display__content">
      ...
      <p class="ds-error-display__message">{{ message || error?.message || defaultMessage }}</p>
      
      <details v-if="showDetails && (error || details)" class="ds-error-display__details">
...
import { WarningFilled, CircleCloseFilled, InfoFilled, RefreshRight } from '@element-plus/icons-vue';
