<template>
  <el-tabs v-model="activeTab" type="border-card">
    <el-tab-pane :label="$t('elections.tabs.basicInfo')" name="basic">
    ...
    <el-tab-pane :label="$t('elections.tabs.electionRules')" name="rules">
    ...
    <el-tab-pane :label="$t('elections.tabs.votingMethods')" name="voting-methods">
    ...
    <el-tab-pane :label="$t('elections.tabs.onlineVoting')" name="online-voting">
      ...
      <el-form-item :label="$t('elections.form.onlineSelectionProcess')" prop="onlineSelectionProcess">
        <el-select v-model="modelValue.onlineSelectionProcess" :placeholder="$t('elections.form.onlineSelectionProcessPlaceholder')">
    ...
    <el-tab-pane :label="$t('elections.tabs.communication')" name="communication">
      <el-form-item :label="$t('elections.form.emailFromAddress')" prop="emailFromAddress">
        <el-input v-model="modelValue.emailFromAddress" :placeholder="$t('elections.form.emailFromAddressPlaceholder')" />
      </el-form-item>
    ...
    <el-tab-pane :label="$t('elections.tabs.displayPrivacy')" name="display-privacy">
    ...
    <el-tab-pane :label="$t('elections.tabs.advanced')" name="advanced">
      ...
      <el-form-item :label="$t('elections.form.linkedElectionKind')" prop="linkedElectionKind">
        <el-select v-model="modelValue.linkedElectionKind" :placeholder="$t('elections.form.linkedElectionKindPlaceholder')">
...
import { ref } from 'vue';
import type { CreateElectionDto, UpdateElectionDto, ElectionSummaryDto } from '../../types';
