  ...
  <el-tabs v-model="activeTab" class="electionFormTabs" type="border-card">
    <el-tab-pane :label="tabLabel('basic', $t('elections.tabs.basicInfo'))" name="basic">
      <el-form-item :label="$t('elections.form.name')" prop="name">
        <el-input v-model="modelValue.name" :placeholder="$t('elections.form.namePlaceholder')" />
      </el-form-item>

      <el-form-item :label="$t('elections.form.date')" prop="dateOfElection">
        <el-date-picker v-model="modelValue.dateOfElection" type="date"
          :placeholder="$t('elections.form.datePlaceholder')" style="width: 100%" />
      </el-form-item>

      <el-form-item :label="$t('elections.form.convenor')" prop="convenor">
        <el-input v-model="modelValue.convenor" :placeholder="$t('elections.form.convenorPlaceholder')" />
      </el-form-item>

      <el-form-item :label="$t('elections.form.type')" prop="electionType">
        <el-select v-model="modelValue.electionType" :placeholder="$t('elections.form.typePlaceholder')">
      ...
      <el-form-item :label="$t('elections.form.electionMode')" prop="electionMode">
        <el-select v-model="modelValue.electionMode" :placeholder="$t('elections.form.modePlaceholder')">
    ...
    <el-tab-pane :label="tabLabel('rules', $t('elections.tabs.electionRules'))" name="rules">
      ...
      <el-form-item :label="$t('elections.form.canVote')" prop="canVote">
        <el-select v-model="modelValue.canVote" :placeholder="$t('elections.form.canVotePlaceholder')">
      ...
      <el-form-item :label="$t('elections.form.canReceive')" prop="canReceive">
        <el-select v-model="modelValue.canReceive" :placeholder="$t('elections.form.canReceivePlaceholder')">
          <el-option label="Yes" value="Y" />
          <el-option label="No" value="N" />
          <el-option label="Unknown" value="?" />
        </el-select>
    ...
    <el-tab-pane :label="tabLabel('voting-methods', $t('elections.tabs.votingMethods'))" name="voting-methods">
      ...
      <el-form-item :label="$t('elections.form.customMethods')" prop="customMethods">
        <el-input v-model="modelValue.customMethods" :placeholder="$t('elections.form.customMethodsPlaceholder')" />
        <template #help>
      ...
      <el-form-item :label="$t('elections.form.votingMethods')" prop="votingMethods">
        <el-input v-model="modelValue.votingMethods" :placeholder="$t('elections.form.votingMethodsPlaceholder')" />
        <template #help>
    ...
    <el-tab-pane :label="tabLabel('online-voting', $t('elections.tabs.onlineVoting'))" name="online-voting">
      <el-form-item :label="$t('elections.form.onlineWhenOpen')" prop="onlineWhenOpen">
        <el-date-picker v-model="modelValue.onlineWhenOpen" type="datetime"
          :placeholder="$t('elections.form.onlineWhenOpenPlaceholder')" style="width: 100%" />
      </el-form-item>

      <el-form-item :label="$t('elections.form.onlineWhenClose')" prop="onlineWhenClose">
        <el-date-picker v-model="modelValue.onlineWhenClose" type="datetime"
          :placeholder="$t('elections.form.onlineWhenClosePlaceholder')" style="width: 100%" />
      </el-form-item>
      ...
      <el-form-item :label="$t('elections.form.onlineSelectionProcess')" prop="onlineSelectionProcess">
        <el-select v-model="modelValue.onlineSelectionProcess"
      ...
      <el-form-item :label="$t('elections.form.onlineAnnounced')" prop="onlineAnnounced">
        <el-date-picker v-model="modelValue.onlineAnnounced" type="datetime"
          :placeholder="$t('elections.form.onlineAnnouncedPlaceholder')" style="width: 100%" />
      </el-form-item>
    </el-tab-pane>

    <el-tab-pane :label="tabLabel('communication', $t('elections.tabs.communication'))" name="communication">
      <el-form-item :label="$t('elections.form.emailFromAddress')" prop="emailFromAddress">
        <el-input v-model="modelValue.emailFromAddress"
      ...
      <el-form-item :label="$t('elections.form.emailFromName')" prop="emailFromName">
        <el-input v-model="modelValue.emailFromName" :placeholder="$t('elections.form.emailFromNamePlaceholder')" />
      </el-form-item>

      <el-form-item :label="$t('elections.form.emailSubject')" prop="emailSubject">
        <el-input v-model="modelValue.emailSubject" :placeholder="$t('elections.form.emailSubjectPlaceholder')" />
      </el-form-item>

      <el-form-item :label="$t('elections.form.emailText')" prop="emailText">
        <el-input v-model="modelValue.emailText" type="textarea" :rows="6"
          :placeholder="$t('elections.form.emailTextPlaceholder')" />
      </el-form-item>

      <el-form-item :label="$t('elections.form.smsText')" prop="smsText">
        <el-input v-model="modelValue.smsText" type="textarea" :rows="3"
          :placeholder="$t('elections.form.smsTextPlaceholder')" />
      </el-form-item>
    </el-tab-pane>

    <el-tab-pane :label="tabLabel('display-privacy', $t('elections.tabs.displayPrivacy'))" name="display-privacy">
    ...
    <el-tab-pane :label="tabLabel('advanced', $t('elections.tabs.advanced'))" name="advanced">
      <el-form-item :label="$t('elections.form.electionPasscode')" prop="electionPasscode">
        <el-input v-model="modelValue.electionPasscode" type="password" show-password
      ...
      <el-form-item :label="$t('elections.form.linkedElection')" prop="linkedElectionGuid">
        {{ availableElections.length }}
        {{
          $t("elections.form.linkedElectionCount", { count: availableElections.length })
        }}
        <el-select v-model="modelValue.linkedElectionGuid" :placeholder="$t('elections.form.linkedElectionPlaceholder')"
          clearable filterable>
          <el-option v-for="election in availableElections.filter((x) => x)" :key="election.electionGuid"
            :label="election.name" :value="election.electionGuid" />
        </el-select>
        <template #help>
      ...
      <el-form-item :label="$t('elections.form.linkedElectionKind')" prop="linkedElectionKind">
        <el-select v-model="modelValue.linkedElectionKind"
      ...
      <el-form-item :label="$t('elections.form.flags')" prop="flags">
        <el-input v-model="modelValue.flags" type="textarea" :rows="4"
