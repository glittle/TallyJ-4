...
export function useDesignTokens() {
  const tokens = computed<DesignTokens>(() => ({
    colors: {
      primary: {
        50: getComputedStyle(document.documentElement)
          .getPropertyValue("--color-primary-50")
          .trim(),
        100: getComputedStyle(document.documentElement)
          .getPropertyValue("--color-primary-100")
          .trim(),
        200: getComputedStyle(document.documentElement)
          .getPropertyValue("--color-primary-200")
          .trim(),
        300: getComputedStyle(document.documentElement)
          .getPropertyValue("--color-primary-300")
          .trim(),
        400: getComputedStyle(document.documentElement)
          .getPropertyValue("--color-primary-400")
          .trim(),
        500: getComputedStyle(document.documentElement)
          .getPropertyValue("--color-primary-500")
          .trim(),
        600: getComputedStyle(document.documentElement)
          .getPropertyValue("--color-primary-600")
          .trim(),
        700: getComputedStyle(document.documentElement)
          .getPropertyValue("--color-primary-700")
          .trim(),
        800: getComputedStyle(document.documentElement)
          .getPropertyValue("--color-primary-800")
          .trim(),
        900: getComputedStyle(document.documentElement)
      ...
      gray: {
        ...
        300: getComputedStyle(document.documentElement)
          ...
          .trim(),
        400: getComputedStyle(document.documentElement)
          .getPropertyValue("--color-gray-400")
          .trim(),
        500: getComputedStyle(document.documentElement)
      ...
      success: {
        50: getComputedStyle(document.documentElement)
          .getPropertyValue("--color-success-50")
          .trim(),
        500: getComputedStyle(document.documentElement)
          .getPropertyValue("--color-success-500")
          .trim(),
        600: getComputedStyle(document.documentElement)
          .getPropertyValue("--color-success-600")
          .trim(),
        700: getComputedStyle(document.documentElement)
          .getPropertyValue("--color-success-700")
          .trim(),
      },
      warning: {
        50: getComputedStyle(document.documentElement)
          .getPropertyValue("--color-warning-50")
          .trim(),
        500: getComputedStyle(document.documentElement)
          .getPropertyValue("--color-warning-500")
          .trim(),
        600: getComputedStyle(document.documentElement)
          .getPropertyValue("--color-warning-600")
          .trim(),
        700: getComputedStyle(document.documentElement)
          .getPropertyValue("--color-warning-700")
          .trim(),
      },
      error: {
        50: getComputedStyle(document.documentElement)
          .getPropertyValue("--color-error-50")
          .trim(),
        500: getComputedStyle(document.documentElement)
          .getPropertyValue("--color-error-500")
          .trim(),
        600: getComputedStyle(document.documentElement)
          .getPropertyValue("--color-error-600")
          .trim(),
        700: getComputedStyle(document.documentElement)
          .getPropertyValue("--color-error-700")
          .trim(),
      },
      bg: {
      ...
      text: {
        ...
        tertiary: getComputedStyle(document.documentElement)
          ...
          .trim(),
        inverse: getComputedStyle(document.documentElement)
    ...
    spacing: {
      ...
      2: getComputedStyle(document.documentElement)
        ...
        .trim(),
      3: getComputedStyle(document.documentElement)
        .getPropertyValue("--spacing-3")
        .trim(),
      4: getComputedStyle(document.documentElement)
        .getPropertyValue("--spacing-4")
        .trim(),
      5: getComputedStyle(document.documentElement)
        .getPropertyValue("--spacing-5")
        .trim(),
      6: getComputedStyle(document.documentElement)
        .getPropertyValue("--spacing-6")
        .trim(),
      8: getComputedStyle(document.documentElement)
        .getPropertyValue("--spacing-8")
        .trim(),
      10: getComputedStyle(document.documentElement)
        .getPropertyValue("--spacing-10")
        .trim(),
      12: getComputedStyle(document.documentElement)
        .getPropertyValue("--spacing-12")
        .trim(),
      16: getComputedStyle(document.documentElement)
        .getPropertyValue("--spacing-16")
        .trim(),
      20: getComputedStyle(document.documentElement)
        .getPropertyValue("--spacing-20")
        .trim(),
      24: getComputedStyle(document.documentElement)
        .getPropertyValue("--spacing-24")
        .trim(),
    },
    fontSize: {
      ...
      xl: getComputedStyle(document.documentElement)
        .getPropertyValue("--font-size-xl")
        .trim(),
      "2xl": getComputedStyle(document.documentElement)
        .getPropertyValue("--font-size-2xl")
        .trim(),
      "3xl": getComputedStyle(document.documentElement)
        .getPropertyValue("--font-size-3xl")
        .trim(),
      "4xl": getComputedStyle(document.documentElement)
        .getPropertyValue("--font-size-4xl")
        .trim(),
    },
    fontWeight: {
      normal: parseInt(
        getComputedStyle(document.documentElement)
          .getPropertyValue("--font-weight-normal")
          .trim(),
      ),
      medium: parseInt(
        getComputedStyle(document.documentElement)
    ...
    lineHeight: {
      tight: parseFloat(
        getComputedStyle(document.documentElement)
          .getPropertyValue("--line-height-tight")
          .trim(),
      ),
      normal: parseFloat(
        getComputedStyle(document.documentElement)
      ...
      relaxed: parseFloat(
        getComputedStyle(document.documentElement)
          .getPropertyValue("--line-height-relaxed")
          .trim(),
      ),
    },
    radius: {
      ...
      lg: getComputedStyle(document.documentElement)
        ...
        .trim(),
      xl: getComputedStyle(document.documentElement)
        .getPropertyValue("--radius-xl")
        .trim(),
      "2xl": getComputedStyle(document.documentElement)
        .getPropertyValue("--radius-2xl")
        .trim(),
      full: getComputedStyle(document.documentElement)
    ...
    shadow: {
      ...
      md: getComputedStyle(document.documentElement)
        ...
        .trim(),
      lg: getComputedStyle(document.documentElement)
        .getPropertyValue("--shadow-lg")
        .trim(),
      xl: getComputedStyle(document.documentElement)
        .getPropertyValue("--shadow-xl")
        .trim(),
    },
    transition: {
      ...
      normal: getComputedStyle(document.documentElement)
        ...
        .trim(),
      slow: getComputedStyle(document.documentElement)
    ...
    zIndex: {
      ...
      fixed: parseInt(
        getComputedStyle(document.documentElement)
          .getPropertyValue("--z-fixed")
          .trim(),
      ),
      modalBackdrop: parseInt(
        getComputedStyle(document.documentElement)
