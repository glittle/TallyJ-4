const CACHE_NAME = 'tallyj-v1';
const STATIC_CACHE_NAME = 'tallyj-static-v1';
const API_CACHE_NAME = 'tallyj-api-v1';
...
self.addEventListener('fetch', (event) => {
  ...
  // Skip caching for non-HTTP/HTTPS requests (e.g., chrome-extension)
