...
**Public Status Document**: https://docs.google.com/document/d/1mlxI_5HWyt-zdr0EyGPzrScInqUXhA5WbT7d0Mb7gJQ/view
...
- **Default Values**:
  - `Election.ElectionGuid` (GUID generation with timestamp - change to rely on EF sequential GUID generation)
...
- .NET 10.0 SDK installed on development machines
...
- `.zenflow/tasks` - Overall documents
