...
**CRITICAL FINDING:** v3 uses a **4-step wizard**, NOT a simple form

### Step 1: Define the Election

**Layout:** Single-page form with expandable sections

**Core Settings:**
- Type of Election (dropdown: Unit Convention, LSA, etc.)
- Variation (dropdown: Normal Election, International, etc.)
...
- Date of Election (date picker with Perfection date calculation)
- Just Testing? (Yes/No radio with explanation)
...
- Access Code (text input labeled "testsetst" in example)
  ...
  - Can be changed from "Another Progress" page
- Can Add People? (Yes/No radio)
  - Controls whether non-logged-in tellers can add new names
...
**Example Data:**
- Bahrami, Sohrab | | | Processed ☑ | Kiosk ☑ | Online: 2023 Apr 29, 1:42 pm; Front Desk: 2023 Apr 29, 1:34 pm; kiosk code: Kiosk
- Zarei, Mona | | +14034027106 | Submitted - ☑ | In Person ☑ | Front Desk: 2023 Apr 29, 1:46 pm; In Person: Glen
...
The entire application changes based on election state. v4 needs similar state management for navigation.

### 3. Location Context Everywhere
Location dropdown appears on multiple pages (Front Desk, Ballot Entry). It's a core part of the UI, not an optional feature.
...
2. Teller dropdown on Front Desk and Ballot Entry
