...
2. **No Nominations**: All eligible persons are candidates
3. **Plurality Voting**: Each vote counts equally (1 point)
4. **Tie-Breaking**: Ties resolved by additional election
...
- **Storage**: SQL Server database
- **Management**: Tellers created by election administrators
...
#### Authentication Flow
1. **Registration**: Voter provides email or phone
2. **Code Generation**: System generates one-time verification code
3. **Code Delivery**: Send via email or SMS
...
1. **Anonymous**: Public election listings, voter registration
2. **Voter**: Online ballot submission (System 3)
3. **Teller**: Ballot entry, election management (System 2)
4. **Admin**: Full system access (System 1)
...
#### Data Protection
- **PII Handling**: Email/phone stored encrypted
